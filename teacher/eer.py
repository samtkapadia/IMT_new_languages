...
# This code may be freely distributed, but citations should still be made to:
# E. Johns et al, "Becoming the Expert - Interactive Multi-Class Machine Teaching", in Proceedings of CVPR 2015
########################################################################
...
def get_next_sample(X, Y, W, L, testing_samples):
    ...
    for u in range(nU):
        ...
        # Calculate the new state of the GRF if this sample were to be revealed to the user (here, we assume that the
        # user's belief of this sample will then be the ground truth -- debatable...)
